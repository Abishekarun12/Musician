     ...
     class="font-montserrat">
        <header class="h-24 sm:h-32 pt-6 flex items-center">
            <div class="container mx-auto px-6 sm:px-12 flex items-center justify-between">
                ...
                <div  style="color: white" class="text-pink font-pink text-4xl flex items-center">
                    <span>
                ...
                <div class="flex items-center">
                    <nav class="text-pink text-lg hidden lg:flex items-center">
                        ...
                        @if (Route::has('admin.login'))
                            <a href="{{ route('admin.login') }}" style="color: white" class="py-2 px-6 flex hover:text-green-500">Admin</a>
                        @endif

                        @if (Route::has('login'))
                            @auth('front')
                                <a href="{{ url('/dashboard') }}"  style="color: white" class="py-2 px-6 flex hover:text-blue-500">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}"  style="color: white"  class="py-2 px-6 flex hover:text-blue-500">Log in</a>
            ...
            <div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row items-center gap-10 ">
                <div class=" flex flex-col items-start mt-8 sm:mt-0 ">
                    ...
                    <h1 class="text-4xl lg:text-6xl leading-none mb-4">
                        <strong class="font-black">Feel The Musics
                       <br>
